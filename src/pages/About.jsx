...
import { MotionDivToRight, MotionDivToLeft } from "../utils/motion";
...
const About = () => {
    ...
    const content = <div className="flex flex-col xl:flex-row w-fit h-full gap-y-7 lg:gap-x-10 md:gap-y-0 md:items-center lg:items-start">
            {/* PICTURE */}
            <MotionDivToRight className="sm:flex hidden">
                <div className="hidden drop-shadow-image sm:flex w-[150px] md:w-[217px] xl:w-[317px] h-[145px] md:h-[215px] xl:h-[380px] bg-meAI hover:bg-me rounded-xl bg-cover bg-center md:place-self-center transition-all duration-200 ease-linear"/>
            </MotionDivToRight>

            {/* RIGHT SIDE */}
            <div className="flex flex-col w-max mt-4 xl:mt-0">
                {/* TITLE */}
                <MotionDivToLeft transition={{delay: 0.2, duration: 0.2}}>
